// Fitness tracker program v0
// 4 workouts: upper body, lower body, core, cardio
// 4 weeks
// 4 workout totals: 1 for each week

// 26/05
// Input: - start with taking the workout frequencies for all 4 weeks at
//		  	once instead of repeating cout and cin code lines. Prioritising
//		  	less text and more overview for now
//		  - no line break after input request message for more compact
//			view for me/potential users
// Style: - added //// to visually separate sections and sub sections
...
int main () {
	...
	// Monthly total
	switch (count) {
			case 1: totalOutput = upperTotal;
				break;
			case 2: totalOutput = lowerTotal;
				break;
			case 3: totalOutput = coreTotal;
				break;
			case 4: totalOutput = cardioTotal;
				break; }
				
	// Level
	switch (count) {
			case 1: feedback = upperLevel;
				break;
			case 2: feedback = lowerLevel;
				break;
			case 3: feedback = coreLevel;
				break;
			case 4: feedback = cardioLevel;
				break; }
